                    ...
                    <table class="table table-striped" id='table1'>
                        <thead>
                            <tr>
                                ...
                                foreach ($bentuks as $bentuk)
                                {
                                    echo "<td width=\"100px\"><b>".$bentuk."</b></td>";
                                }
                                ?>
                        ...
                        <tbody>
                            <tr>
                                ...
                                foreach ($bentuks as $bentuk)
                                {
                                    ...
                                    $namakecil = str_replace(".","",$namakecil);
                                    $namakecil = str_replace(".","",$namakecil);
                                    $totalakreditasi_a = $totalakreditasi_a + $datasekolahanbentuk[$namakecil.'_akreditasi_a'];
                                }?>
                                <td align="right">
                                <?=number_format($totalakreditasi_a,0,",",".")?>
                                </td>
                                <?php
                                foreach ($bentuks as $bentuk)
                                {
                                    ...
                                    $namakecil = str_replace(".","",$namakecil);
                                    $namakecil = str_replace(".","",$namakecil);
                                    echo "<td align='right'>".number_format($datasekolahanbentuk[$namakecil.'_akreditasi_a'],0,',','.')."</td>";
                                    $kolom[$bentuk] = $kolom[$bentuk] + $datasekolahanbentuk[$namakecil.'_akreditasi_a'];
                                }
                                ?>
                            ...
                            <tr>
                                ...
                                foreach ($bentuks as $bentuk)
                                {
                                    ...
                                    $namakecil = str_replace(".","",$namakecil);
                                    $namakecil = str_replace(".","",$namakecil);
                                    $totalakreditasi_b = $totalakreditasi_b + $datasekolahanbentuk[$namakecil.'_akreditasi_b'];
                                }?>
                                <td align="right">
                                <?=number_format($totalakreditasi_b,0,",",".")?>
                                </td>
                                <?php
                                foreach ($bentuks as $bentuk)
                                {
                                    ...
                                    $namakecil = str_replace(".","",$namakecil);
                                    $namakecil = str_replace(".","",$namakecil);
                                    echo "<td align='right'>".number_format($datasekolahanbentuk[$namakecil.'_akreditasi_b'],0,',','.')."</td>";
                                    $kolom[$bentuk] = $kolom[$bentuk] + $datasekolahanbentuk[$namakecil.'_akreditasi_b'];
                                }
                                ?>                                
                            </tr>
                            <tr>
                                ...
                                foreach ($bentuks as $bentuk)
                                {
                                    ...
                                    $namakecil = str_replace(".","",$namakecil);
                                    $namakecil = str_replace(".","",$namakecil);
                                    $totalakreditasi_c = $totalakreditasi_c + $datasekolahanbentuk[$namakecil.'_akreditasi_c'];
                                }?>
                                <td align="right">
                                <?=number_format($totalakreditasi_c,0,",",".")?>
                                </td>
                                <?php
                                foreach ($bentuks as $bentuk)
                                {
                                    ...
                                    $namakecil = str_replace(".","",$namakecil);
                                    $namakecil = str_replace(".","",$namakecil);
                                    echo "<td align='right'>".number_format($datasekolahanbentuk[$namakecil.'_akreditasi_c'],0,',','.')."</td>";
                                    $kolom[$bentuk] = $kolom[$bentuk] + $datasekolahanbentuk[$namakecil.'_akreditasi_c'];
                                }
                                ?>
                            </tr>
                            <tr>
                                ...
                                foreach ($bentuks as $bentuk)
                                {
                                    ...
                                    $namakecil = str_replace(".","",$namakecil);
                                    $namakecil = str_replace(".","",$namakecil);
                                    $totalakreditasi_d = $totalakreditasi_d + $datasekolahanbentuk[$namakecil.'_akreditasi_terakreditasi'];
                                }?>
                                <td align="right">
                                <?=number_format($totalakreditasi_d,0,",",".")?>
                                </td>
                                <?php
                                foreach ($bentuks as $bentuk)
                                {
                                    ...
                                    $namakecil = str_replace(".","",$namakecil);
                                    $namakecil = str_replace(".","",$namakecil);
                                    echo "<td align='right'>".number_format($datasekolahanbentuk[$namakecil.'_akreditasi_terakreditasi'],0,',','.')."</td>";
                                    $kolom[$bentuk] = $kolom[$bentuk] + $datasekolahanbentuk[$namakecil.'_akreditasi_terakreditasi'];
                                }
                                ?>
                            </tr>
                            <tr>
                                ...
                                foreach ($bentuks as $bentuk)
                                {
                                    ...
                                    $namakecil = str_replace(".","",$namakecil);
                                    $namakecil = str_replace(".","",$namakecil);
                                    $totalakreditasi_e = $totalakreditasi_e + $datasekolahanbentuk[$namakecil.'_akreditasi_tidak_terakreditasi'];
                                }?>
                                <td align="right">
                                <?=number_format($totalakreditasi_e,0,",",".")?>
                                </td>
                                <?php
                                foreach ($bentuks as $bentuk)
                                {
                                    ...
                                    $namakecil = str_replace(".","",$namakecil);
                                    $namakecil = str_replace(".","",$namakecil);
                                    echo "<td align='right'>".number_format($datasekolahanbentuk[$namakecil.'_akreditasi_tidak_terakreditasi'],0,',','.')."</td>";
                                    $kolom[$bentuk] = $kolom[$bentuk] + $datasekolahanbentuk[$namakecil.'_akreditasi_tidak_terakreditasi'];
                                }
                                ?>
                            </tr>
                            <tr>
                                ...
                                foreach ($bentuks as $bentuk)
                                {
                                    ...
                                    $namakecil = str_replace(".","",$namakecil);
                                    $namakecil = str_replace(".","",$namakecil);
                                    $totalakreditasi_f = $totalakreditasi_f + $datasekolahanbentuk[$namakecil.'_akreditasi_belum_terakreditasi'];
                                }?>
                                <td align="right">
                                <?=number_format($totalakreditasi_f,0,",",".")?>
                                </td>
                                <?php
                                foreach ($bentuks as $bentuk)
                                {
                                    ...
                                    $namakecil = str_replace(".","",$namakecil);
                                    $namakecil = str_replace(".","",$namakecil);
                                    echo "<td align='right'>".number_format($datasekolahanbentuk[$namakecil.'_akreditasi_belum_terakreditasi'],0,',','.')."</td>";
                                    $kolom[$bentuk] = $kolom[$bentuk] + $datasekolahanbentuk[$namakecil.'_akreditasi_belum_terakreditasi'];
                                }
                                ?>
                            </tr>
                            <tr>
                                ...
                                foreach ($bentuks as $bentuk)
                                {
                                    $totalsemua = $totalsemua + $kolom[$bentuk];
                                }
                                ?>
                                <td style="padding-left:20px;" align="right">
                                <b><?=number_format($totalsemua,0,",",".")?></b>
                                </td>
                                <?php 
                                foreach ($bentuks as $bentuk)
                                {
                                    echo "<td align=\"right\">".number_format($kolom[$bentuk],0,",",".")."</td>";
                                }
                                ?>
